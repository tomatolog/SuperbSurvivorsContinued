...
context_options.show_context_menu_order = function(member_index)
    ...
    context_menu:addOption("Barricade (GOAP)", nil, function() goap_test.GiveBarricadeOrder(member_index) end)
end
...
context_options.show_context_menu_role = function(member_index)
    ...
    sub_order:addOption("Barricade (GOAP)", nil, function() goap_test.GiveBarricadeOrder(member_index) end)
